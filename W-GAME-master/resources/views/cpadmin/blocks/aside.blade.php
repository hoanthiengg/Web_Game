<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <img src="{{asset('cpadmin/dist/img/AdminLTELogo.png')}}"
        ...
        style="opacity: .8">
    <span class="brand-text font-weight-light">W-Game</a></span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="{{asset('cpadmin/dist/img/logo00.jpg')}}" class="img-circle elevation-2" width="160px" height="160px" alt="User Image">
            </div>
            <div class="info">
                <a href="#" class="d-block">GamePAB</a>
            </div>
        </div>
        <!-- Sidebar Menu -->
        <nav class="mt-2">
